...
function WorkspaceOverview({ onNavigateApis, onNavigateKeys, onOpenSettings }) {
  const { collections, apiKeys, workspaceName } = useWorkspace();
  const { user } = useAuth();
  const [activeTab, setActiveTab] = useState('overview');

  const totalApis = collections.reduce((acc, c) => acc + c.apis.length, 0);
    ...
    <div className="wb-overview">
      ...
      <div className="wb-overview-top">
        ...
        <div className="wb-overview-actions">
          <button type="button" className="wb-ov-btn" onClick={() => alert('Documentación generada en formato Markdown')}>
          ...
          <button type="button" className="wb-ov-btn" onClick={onNavigateApis}>
            <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <button type="button" className="wb-ov-btn wb-ov-btn--primary" onClick={() => alert(`Enlace de invitación copiado para ${user.email}`)}>
            <svg viewBox="0 0 24 24" width="13" height="13" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="wb-overview-body">
        ...
        {/* Welcome Block inspired by Postman layout */}
        <div className="wb-postman-welcome-card">
          ...
          <ul className="wb-welcome-list">
            ...
            <li>
              <strong>Personalizar tu entorno</strong>: Modifica los colores del workspace y ajusta tu perfil desde la barra lateral derecha (⚙️).
            </li>
          </ul>
