export const PRIMARY_THEMES = [
  { id: 'dark', name: 'Negro Profundo', bg: '#0f0f0f', surface: '#181818', surfaceAlt: '#222222', border: '#2d2d2d', text: '#f3f4f6', isDark: true },
  { id: 'light', name: 'Blanco Puro', bg: '#ffffff', surface: '#f8fafc', surfaceAlt: '#f1f5f9', border: '#e2e8f0', text: '#0f172a', isDark: false },
  { id: 'midnight', name: 'Azul Medianoche', bg: '#0b1120', surface: '#0f172a', surfaceAlt: '#1e293b', border: '#1e293b', text: '#f8fafc', isDark: true },
  { id: 'slate', name: 'Gris Carbón', bg: '#18181b', surface: '#27272a', surfaceAlt: '#3f3f46', border: '#3f3f46', text: '#fafafa', isDark: true },
];
